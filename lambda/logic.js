...
function getBirthdayData( day, month, year, timezone ) 
{
...
function createBirthdayReminder( daysUntilBirthday, timezone, locale, message ) 
{
...
function convertBirthdaysResponse( handlerInput, response, withAge, timezone )
{
    let speechResponse = '';
